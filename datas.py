...
element_dict = {
    "金": {
        "color": ["白色", "金色", "银色"],
        "direction": ["西方"],
        "furnishing": ["金属工艺品", "铜器", "不锈钢装饰", "几何造型摆件"],
        "accessory": ["金饰", "银饰", "金属手表", "铜钱挂件"]
    },
    "木": {
        "color": ["绿色", "青色"],
        "direction": ["东方"],
        "furnishing": ["木质家具", "盆栽植物", "竹制工艺品", "纸质装饰"],
        "accessory": ["木手串", "翡翠饰品", "绿松石", "树叶造型饰品"]
    },
    "水": {
        "color": ["黑色", "蓝色", "灰色"],
        "direction": ["北方"],
        "furnishing": ["鱼缸", "水景摆设", "玻璃制品", "波浪造型装饰"],
        "accessory": ["黑曜石", "海蓝宝", "珍珠饰品", "水滴造型吊坠"]
    },
    "火": {
        "color": ["红色", "紫色", "橙色"],
        "direction": ["南方"],
        "furnishing": ["蜡烛台", "暖光灯具", "三角形装饰", "阳光主题画作"],
        "accessory": ["红宝石", "石榴石", "琥珀", "爱心造型饰品"]
    },
    "土": {
        "color": ["黄色", "棕色", "咖啡色"],
        "direction": ["中央", "西南方", "东北方"],
        "furnishing": ["陶瓷制品", "水晶洞", "方形装饰", "山石盆景"],
        "accessory": ["黄水晶", "玛瑙", "玉器", "方形挂件"]
    }
}
